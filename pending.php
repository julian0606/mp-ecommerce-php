...
require_once 'modelo/preferenciaModelo.php';
require_once 'controlador/preferenciaController.php';

$id_preferencia = $_REQUEST['preference_id'];
$respuesta = json_encode( $_REQUEST, JSON_UNESCAPED_SLASHES );

ControladorPreferencia::ctrUpdateRespuesta($respuesta, $id_preferencia);
                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div style=" margin: 50px">
                                <h2 style="color: #ebe405;">Pago pendiente o en proceso de aprobación.</h2>
                                <p>resultado de transacción:</p>
                                <!-- code -->
                                    <pre>
                                        <code>
                                ...
                                <button type="boton" class="mercadopago-button" onclick="window.location = 'index.php'">Volver</button>
                            </div>
                        </div>
                    </div>
                </div>
